...
class attack_data:
    ...
    def __init__(self, train_feature_path, train_lable_path, test_feature_path,
        ...
        self.train_lable = self.generate(self.train_lable)
        ...
        self.test_lable = self.generate(self.test_lable)
...
#        print(list(menber_loader))
    ...
    def generate(self, dataset):
        ...
        """     
        features = torch.tensor(dataset[dataset.columns].values.astype(np.float32))        
        return features
